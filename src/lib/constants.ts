...
export const SERVICE_AREAS = [
  ...
  { name: 'Fruita', slug: 'fruita', main: false },
  { name: 'Palisade', slug: 'palisade', main: false },
  { name: 'Clifton', slug: 'clifton', main: false },
  { name: 'Orchard Mesa', slug: 'orchard-mesa', main: false },
  { name: 'Loma', slug: 'loma', main: false },
  { name: 'Mack', slug: 'mack', main: false },
  { name: 'Whitewater', slug: 'whitewater', main: false },
];
...
export const MAIN_SERVICES = [
  ...
  },
  {
    ...
    name: 'Faucet Repair',
    icon: 'Droplet',
    short: 'Dripping faucets and fixture repairs done right.',
  },
  {
    slug: 'toilet-repair',
    name: 'Toilet Repair',
