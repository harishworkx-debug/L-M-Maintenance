...
export default function ServicePageGJ() {
  ...
  const metaDescription = `Expert ${service.name.toLowerCase()} services in Grand Junction, CO. Fast, reliable, and professional plumbing by ${BUSINESS_NAME}. Call (970) 549-6785.`;
