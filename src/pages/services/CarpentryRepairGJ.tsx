...
export default function CarpentryRepairGJ() {
  return (
    <ServicePageLayout
      ...
      metaDescription="Find residential carpentry repair providers in Grand Junction, CO. Doors, windows, trim, decks, and wood repairs for your home. Free connection. Call (970) 665-3162."
      ...
      faqs={[
        ...
        { q: 'How do I find a carpentry repair provider in Grand Junction?', a: 'Call (970) 665-3162 to connect with available independent local carpentry repair providers in Grand Junction through our free homeowner connection service.' },
      ]}
