...
export default function ElectricalRepairGJ() {
  return (
    <ServicePageLayout
      ...
      metaDescription="Find residential electrical repair providers in Grand Junction, CO. Outlets, switches, panels, and wiring repairs for your home. Call (970) 546-9838 to connect."
