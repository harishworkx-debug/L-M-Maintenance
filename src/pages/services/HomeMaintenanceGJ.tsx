...
export default function HomeMaintenanceGJ() {
  return (
    <ServicePageLayout
      ...
      metaDescription="Find residential home maintenance providers in Grand Junction, CO. Seasonal upkeep, inspections, and ongoing maintenance for your home. Call (970) 546-9838."
      ...
      faqs={[
        ...
        { q: 'How do I find a home maintenance provider in Grand Junction?', a: 'Call (970) 546-9838 to connect with available independent local home maintenance providers in Grand Junction. Our free service makes it easy to find reliable help for your residential property.' },
