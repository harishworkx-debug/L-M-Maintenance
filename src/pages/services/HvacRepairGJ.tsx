...
export default function HvacRepairGJ() {
  return (
    <ServicePageLayout
      ...
      metaDescription="Find residential HVAC repair providers in Grand Junction, CO. Heating and cooling system repair and maintenance for your home. Free connection. Call (970) 546-9838."
      ...
      faqs={[
        { q: 'Why is my air conditioner not cooling my Grand Junction home?', a: 'Common causes include a clogged filter, low refrigerant, a dirty evaporator coil, or a malfunctioning compressor. In Grand Junction\'s intense summer heat, AC issues need prompt attention. Call (970) 546-9838 to connect with a local provider.' },
