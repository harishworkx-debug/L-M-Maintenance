...
export default function WaterHeaterServiceGJ() {
  return (
    <ServicePageLayout
      ...
      metaDescription="Find available water heater repair and service providers in Grand Junction, CO. Residential water heater repair, maintenance, and replacement. Call (970) 546-9838."
      ...
      faqs={[
        ...
        { q: 'How quickly can a local provider address my water heater issue?', a: 'Availability varies by provider and time of day. Call (970) 546-9838 to connect with available independent providers in Grand Junction who may be able to assist with your water heater needs.' },
      ]}
